# ACF Repository Statistics

This directory contains tools and configuration for generating comprehensive repository statistics for the ACF (Application Component Framework) project.

## Overview

The repository statistics system provides both **quantity** and **quality** metrics about the ACF codebase:
...
- **Output**: Available at `https://imagingtools.github.io/Acf/stats/`
...
Components are identified by the ACF framework macro:
```cpp
...
1. **Check workflow logs**: GitHub Actions → Documentation and Statistics workflow
...
This statistics system is part of the ACF project, licensed under LGPL-2.1.
