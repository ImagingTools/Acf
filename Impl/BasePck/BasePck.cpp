...
I_EXPORT_COMPONENT(Uuid, "Unique identifier", "Unique Identifier UUID Generated");
I_EXPORT_COMPONENT(ObjectQueue, "Queue of any objects", "Objects Queue List FIFO Stack Elements Serial Delay Line");
