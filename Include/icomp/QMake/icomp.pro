...
HEADERS += ../CEnvironmentManagerBase.h
...
HEADERS += ../IComponentEnvironmentManager.h
HEADERS += ../IComponentStaticInfo.h
HEADERS += ../IMetaInfoManager.h
...
SOURCES += ../CEnvironmentManagerBase.cpp
SOURCES += ../CFactoryAttribute.cpp
SOURCES += ../CMultFactoryAttribute.cpp
SOURCES += ../CMultiReferenceAttribute.cpp
SOURCES += ../CPackageStaticInfo.cpp
SOURCES += ../CReferenceAttribute.cpp
