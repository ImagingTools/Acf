...
HEADERS += ../IRegistryGeometryProvider.h
HEADERS += ../IRegistryNotesProvider.h
...
HEADERS += ../TMultiAttributePtr.h
HEADERS += ../TMultiFactoryMember.h
HEADERS += ../TMultiReferencePtr.h
HEADERS += ../TReferencePtr.h
HEADERS += ../TSelectableAttribute.h
HEADERS += ../TSimComponentsFactory.h
HEADERS += ../TSimComponentWrap.h
HEADERS += ../TSingleAttribute.h
HEADERS += ../TSingleAttributePtr.h
