...
acf_declare_library_dependencies(i2d		ibase icomp imath imod iprm iser istd Qt${QT_VERSION_MAJOR}::Gui)
...
acf_declare_library_dependencies(ifile		ibase icomp idoc ilog imod iprm iser istd Qt${QT_VERSION_MAJOR}::Concurrent)
...
if(QT_VERSION_MAJOR EQUAL 6)
	...
	acf_declare_library_dependencies(ifilegui	icomp ifile ilog imod iqt iqtgui istd iwidgets Qt${QT_VERSION_MAJOR}::Concurrent Qt${QT_VERSION_MAJOR}::Svg)
endif()
acf_declare_library_dependencies(iloggui	ibase icomp ifile ilog iprm iqt iqtgui istd iwidgets)
acf_declare_library_dependencies(iview		i2d ibase icmm icomp iimg imath imod iqt iqtgui istd iwidgets Qt${QT_VERSION_MAJOR}::Widgets)
