...
public:
	...
	*/
	 ...
	 */
	virtual ProcessorState GetProcessorState(const IParamsSet* paramsPtr) const = 0;
	...
	*/
	virtual int BeginTask(const IParamsSet* paramsPtr, const InputType* inputPtr, const OutputType* outputPtr) = 0;
