#ifndef imebase_CMeilhausSimpleAIComp_included
#define imebase_CMeilhausSimpleAIComp_included
...
public:
	...
	I_BEGIN_COMPONENT(CMeilhausSimpleAIComp)
...
#endif // !imebase_CMeilhausSimpleAIComp_included
